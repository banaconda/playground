...
const char *
cl_error_string(cl_int errCode)
{
    const char *err = NULL;
    switch (errCode) {
    case CL_SUCCESS:
    ...
    case CL_PROFILING_INFO_NOT_AVAILABLE:
        err = "CL_PROFILING_INFO_NOT_AVAILABLE: Unable to get information about events or performance evaluation "
              "command queue does not support performance evaluation!";
        break;
    ...
    case CL_EXEC_STATUS_ERROR_FOR_EVENTS_IN_WAIT_LIST:
        err = "CL_EXEC_STATUS_ERROR_FOR_EVENTS_IN_WAIT_LIST: waiting list in the event of the implementation status "
              "error!";
        break;
    ...
    case CL_INVALID_PROGRAM_EXECUTABLE:
        err = "CL_INVALID_PROGRAM_EXECUTABLE: program fails to successfully build an executable command queue on the "
              "associated device!";
        break;
    ...
    case CL_INVALID_ARG_VALUE:
        err = "CL_INVALID_ARG_VALUE: For a non-local parameter kernel parameter value is NULL; or for a partial "
              "parameter kernel parameter value is not NULL!";
        break;
    ...
    case CL_INVALID_GLOBAL_WORK_SIZE:
        err = "CL_INVALID_GLOBAL_WORK_SIZE: Incoming global work size is not legitimate, it may be zero or out of the "
              "device supports size!";
        break;
